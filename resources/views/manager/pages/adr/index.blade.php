...
@push('page-title-right')
    <a href="{{ route('manager.adr.create') }}" class="btn btn-success waves-effect waves-light">
        <span class="btn-label"><i class="mdi mdi-check-all"></i></span>@lang('add_new')
    </a>
    @endpush
@section('title',__('adr_list'))

@section('content')
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <form action="{{ route('manager.adr.index') }}">
                                ...
                                <td class="justify-content-center">
                                    <div class="dropdown ">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" style="">
                                            <a class="dropdown-item" href="{{ route('manager.adr.edit', $item->id) }}"><i class="mdi mdi-file-edit mr-2 text-muted vertical-middle"></i>@lang('edit')</a>
                                            @include('manager.common.table-dropdown-delete',['url' => route('manager.adr.destroy', $item->id)])
                                        </div>
                                    </div>
                                </td>
                            </tr>
